...
const Post = ({post, setCurrentId }) => { //This file defines the structure of a single post
        ...
        <Card className={classes.card}>
            ...
            <div className={classes.details}>
                ...
                <CardActions className={classes.cardActions}>
                    ...
                    <Button size="small" color="primary" disabled={!(user?.result?._id === post?.creator)} onClick={() => dispatch(deletePost(post._id))}> 
